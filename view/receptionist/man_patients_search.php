    ...
    <div class="container">
            ...
            <div class="col-8">
                <nav class="navbar navbar-light" style="background-color: #e3f2fd;">
                    ...
                    <form action="search_p.php" method="POST" class="form-inline">
                        <input class="form-control mr-sm-2" name="nom_patient" type="search" placeholder="Chercher par nom" aria-label="Search">
        ...
        <div class="row my-4">
            ...
            <table class="table text-center">
                ...
                <tbody>
                <?php
                $search_p = $receptionist -> search_p ($db_info,$nom_patient);
                if (!is_null($search_p)){
                    foreach ($search_p as $key =>$value){
                    echo"<tr>";
